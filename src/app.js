    ...
    <Routes>
      <Route path="/" element={<Layout state={state} handles={handles} />}>
          <Route
            exact
            path="home"
            element={<Home state={state} handles={handles} />}
          />
          <Route
            path="exercicePage"
            element={<ExercicePage state={state} handles={handles} />}
          />
          <Route
            path="LessonPage"
            element={<LessonPage state={state} handles={handles} />}
          />
          <Route
            path="paperPicker"
            element={<PaperPicker state={state} handles={handles} />}
          />
